    ...
    public static class SeedData
    {
        public static void Seed(AppDbContext context)
        {
            ...
            var bookings = new List<Booking>
            {
                ...
                new Booking {  StartDate = DateTime.Parse("10-11-2025"), EndDate = DateTime.Parse("15-11-2025"), GuestCount = 1, Id = 2, Reference = "4acc8ceb-621d-41f1-ae74-de01badd49ee", RoomId =1},
                new Booking {  StartDate = DateTime.Parse("10-11-2025"), EndDate = DateTime.Parse("15-11-2025"), GuestCount = 1, Id = 3, Reference = "6efa9f02-9f39-4bdd-bd81-7150db1a4940", RoomId =1},
                new Booking {  StartDate = DateTime.Parse("10-11-2025"), EndDate = DateTime.Parse("15-11-2025"), GuestCount = 2, Id = 4, Reference = "82f75151-3788-49b0-b534-22ff6b0ffaa5", RoomId =1},
                new Booking {  StartDate = DateTime.Parse("10-11-2025"), EndDate = DateTime.Parse("15-11-2025"), GuestCount = 2, Id = 5, Reference = "18fde892-435d-4def-a149-aa7b489f3a2c", RoomId =1}
